...
def robot(scene):
    ...
    # # Make donut of actuators with the center being stable
    # scene.add_rect(0.04, 0.04, 0.02, 0.02, -1)
    # scene.add_rect(0.02, 0.02, 0.02, 0.06, 0)
    # scene.add_rect(0.04, 0.06, 0.02, 0.02, 1)
    # scene.add_rect(0.06, 0.02, 0.02, 0.06, 2)
    # scene.add_rect(0.04, 0.02, 0.02, 0.02, 3)
    # scene.set_n_actuators(4)

    # # Make bigger donut of actuators with the center being stable
    # scene.add_rect(0.2, 0.2, 0.1, 0.1, -1)
    # scene.add_rect(0.1, 0.1, 0.1, 0.3, 0)
    # scene.add_rect(0.2, 0.3, 0.1, 0.1, 1)
    # scene.add_rect(0.3, 0.1, 0.1, 0.3, 2)
    # scene.add_rect(0.2, 0.1, 0.1, 0.1, 3)
    # scene.set_n_actuators(4)
